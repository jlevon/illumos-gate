	...
	val_t *bootaux)
{
	...
	/*
	 * 'unix' is linked together with 'krtld' into one executable and the
	 * early boot code does -not- hand us any of the dynamic metadata about
	 * the executable. In particular, it does not read in, map or otherwise
	 * look at the program headers. We fake all that up now.
	 *
